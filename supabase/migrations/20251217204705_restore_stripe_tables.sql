/*
  # Restore Stripe Tables and Types

  This migration restores all Stripe-related database objects.
  ...
  3. Security
    ...
    - Adds policies for authenticated users to view their own data
